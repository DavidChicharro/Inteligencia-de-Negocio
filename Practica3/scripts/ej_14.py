...
building_damage_2 = bd_no_outly.drop(columns ="has_secondary_use")
building_damage_2 = building_damage_2.drop(columns ="has_secondary_use_agriculture")
building_damage_2 = building_damage_2.drop(columns ="plan_configuration")
...
df_submission.to_csv("../submissions/submission_14.csv", index=False)
